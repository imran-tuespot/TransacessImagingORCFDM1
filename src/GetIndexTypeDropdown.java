...
public class GetIndexTypeDropdown extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetIndexTypeDropdown() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Vector indexTypes = indexTypeDao.findIndexTypeByProperty("COMPANY_ID", ""+comid);
		...
		try
		{
			 ...
			 if(indexTypes.size() > 0)
			{
					...
					{
						p = new JSONObject();
						indexType = (IndexType) indexTypes.get(i);
						p.put("value",indexType.getIndexTypeId());
						p.put("text",indexType.getIndexType());
						prop.put(p);

					}
					//System.out.println("prop "+prop);
			        json_response.put("indexTypeData", prop);
