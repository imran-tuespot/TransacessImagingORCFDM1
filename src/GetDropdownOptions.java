 ...
 *
 */
 public class GetDropdownOptions extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
...
public String getIndexDropDown(String compid) {
		...
		String select = "select /*+ result_cache */  index_type,index_type_id from index_type where company_id = '"+compid+"' order by index_type";
		String outputstr = "";
	...
	public String getPropertyDropDown(String compid) {
		...
		String select = "select /*+ result_cache */  property_id,id from property where company_id = '"+compid+"' order by property_id";
		String outputstr = "";
	...
	public String getDocDropDown(String compid) {
		...
		String select = "select /*+ result_cache */  document_type,document_type_id from document_type where company_id = '"+compid+"' order by document_type";
		String outputstr = "";
