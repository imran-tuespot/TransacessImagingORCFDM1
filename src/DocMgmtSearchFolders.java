...
public class DocMgmtSearchFolders extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //String andOr = "and";
        System.out.println("Inside servlet DocMgmtSearchFolder");
        ...
        if (sid <= -1) {
            ...
            System.out.println("In Get Files : Session Expired ");
        } else {
            System.out.println("In Get Files : Getting List of Files ");
