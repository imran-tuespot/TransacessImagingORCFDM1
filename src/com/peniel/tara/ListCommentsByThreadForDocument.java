/**
 * ListCommentsByThreadForDocument.java
 *
...
public class ListCommentsByThreadForDocument  implements java.io.Serializable {
    private java.lang.String loginContextId;

    private com.peniel.tara.ListCommentParamsDTO listCommentParamsDto;

    public ListCommentsByThreadForDocument() {
    }
    ...
    /**
     * Gets the loginContextId value for this ListCommentsByThreadForDocument.
     * 
    ...
    /**
     * Sets the loginContextId value for this ListCommentsByThreadForDocument.
     * 
    ...
    /**
     * Gets the listCommentParamsDto value for this ListCommentsByThreadForDocument.
     * 
    ...
    /**
     * Sets the listCommentParamsDto value for this ListCommentsByThreadForDocument.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ListCommentsByThreadForDocument)) return false;
        ListCommentsByThreadForDocument other = (ListCommentsByThreadForDocument) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ListCommentsByThreadForDocument.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://pleasetech.com/tara/taraws", ">ListCommentsByThreadForDocument"));
