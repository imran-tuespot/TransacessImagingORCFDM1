...
public class DeleteFolder  implements java.io.Serializable {
    ...
    /**
     * Gets the loginContextId value for this DeleteFolder.
     * 
    ...
    /**
     * Sets the loginContextId value for this DeleteFolder.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://pleasetech.com/tara/taraws", ">DeleteFolder"));
