...
public class DeleteDocument  implements java.io.Serializable {
    ...
    /**
     * Gets the loginContextId value for this DeleteDocument.
     * 
    ...
    /**
     * Sets the loginContextId value for this DeleteDocument.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://pleasetech.com/tara/taraws", ">DeleteDocument"));
