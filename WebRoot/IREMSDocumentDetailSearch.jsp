...
function getHtmlReport(type){
	...
	$.ajax({
		...
		url : "<%=restURL%>/role/getDocumentsIrmsDetailReport?"+param,
		dataType : 'json',
		timeout : 100000,
	  //data:JSON.stringify({'email':email,'phone':mnumber,'ccode':'+91','userId':userid,'not':'nosms'}),
		success : function(recordsdata) {
			...
			if(recordsdata.key=="200"){
				var totalrecords='';
				 totalrecords=recordsdata.documenttype.length;
				        ...
				        buttons: [
				        	{ extend : 'excelHtml5',
				        		title:"iREMS (Detailed) Report",
				        		text:"EXCEL REPORT",
				        		filename:"iREMS (Detailed) Report",
						  ...
						  "aoColumns": [
		   		        ...
		   		        ajax: function ( data, callback, settings ) {
		   		         ...
		   		         var out = [];
		 		 		$.each(recordsdata.documenttype, function(i, obj) {
		 		 	 		// if(obj.fileName!=null){
		 		 	 			name=obj.fileName;
		 		 	 		/*  }else{
		 		 	 			name='LF User';
		 		 	 		...
		 		 	 		out.push( [obj.propertyName,obj.actualFileName,obj.documentType,
		 		 	 			obj.version,
		 		 	 			obj.createDate,name]);
		 		 	 	});
		...
		error : function(e) {
			...
			$("#result").text("Please Enter  IREMS #");	
		}		
}
...
function initial_load()
	...
	setHeader('IREMSDocumentDetailSearch.jsp');
	setHeaderText('iREMS (Detailed) Report','Reporting & Analysis','dashboard.jsp?reports=true');
...
//-->
	...
	<section class="upload-document">
        <div class="container-fluid">
            ...
            <br>
                <h4 style="color: #0a68b4;">iREMS (Detailed) Report</h4>
				<hr>
				<div>This Report provides you with every available Record based on the iREMS Number provided.<br>
&nbsp The Fields include: ( iREMS #, File Name, Document Type,Version , Date Uploaded,Record Originator )</div><br>
                ...
                <div class="upload-dates col-sm-12">
                   ...
                   <div class="form-group">
                            ...
                            <div class="row">
                                <label class="control-label col-sm-4">IREMS Number <span class="requiredStar">*</span></label>
                                <div class="col-sm-4">
                                    <input style="height: 25px;    border: 2px solid #ccc;" type="text" class="form-control" id="IREMS" name="IREMS">
                                </div>
