...
<% 
  System.out.println("***addBatch.jsp***"); 
...
<tr align="right">
<td style="padding:0px 0px 8px 8px">&nbsp;<input type="button" name="save" value="Save" disabled="disabled"> 
<input type="button" name="saveandnew" value="Save & Add New" onClick="javascript:replaceDoc();" disabled="disabled"> 
...
<div class="blueHeaderNoRound">
	<div class="blueHeaderNoRoundText">Batch Upload History:</div>
</div>
...
if (x.lastIndexOf(".pdf") != -1
        || x.lastIndexOf(".zip") != -1  || x.lastIndexOf(".ZIP") != -1 ) {
    return true;
} else {
