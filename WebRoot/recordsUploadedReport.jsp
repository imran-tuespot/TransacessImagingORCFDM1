...
if(month||year){
	if(year){
		...
		return false;
	   	...
	   	var param="startDate="+datef+"&endDate="+dates+"&year="+year+"&month="+month+"&uploadType=U";
	$("#loadingImage").show();

	$.ajax({
		type : "GET",
		contentType : "application/json",
		url : "<%=restURL%>/role/getUsersUploadReport?"+param,
		dataType : 'json',
		timeout : 100000,
					  ...
					  dates=year;
					   displaydate=datef+","+dates;
				   		...
				   		$("#myTable").dataTable({
					        ...
					        buttons: [
					        	{ extend : 'excelHtml5',
					        		title:"Records Uploaded Report",
					        		text:"EXCEL REPORT",
					        		filename:"Records Uploaded Report",
...
$(function() {
	...
	setHeader('recordsUploadedReport.jsp');
	$("#loadingImage").hide();
...
function initial_load()
	{
	setHeaderText('Records Uploaded','Reporting & Analysis','dashboard.jsp?reports=true');
...
//-->
	...
	<section class="upload-document">
        <div class="container-fluid">
            ...
            <br>
                <h4 style="color: #0a68b4;">Records Uploaded Report</h4>
				<hr>
				<div>
				This Report will provide information on all Records uploaded within a date range.<br>
