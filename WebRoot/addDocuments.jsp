	...
	<div id="flip-tabs" >  
		...
		<div class="tabbox">		
	        <ul id="flip-navigation" >  
	            <li class="selected"><a href="#content" onclick="javascript:tabContent0()" id="tab-0"  >Document Information</a></li>  
	           <li><a href="#folderTab" id="tab-1" onclick="javascript:tabContent1()">Folder Information</a></li>
	            <li><a href="#uploadDocTab" id="tab-2"  onclick="javascript:tabContent2()">Upload Document</a></li>  
	        </ul>  
	     </div>
        
        <form name="upload" id="upload" method="post" action="UploadFiles" enctype="multipart/form-data"  onsubmit="return false;">
						...
						<div style="color:black;font-size: 13px;top:50%;">
                          ...
                          <span id="textError" style="color: red;"></span>
									...
									<tbody>
										<tr >
											...
											<td style="border-bottom: 0px;border-top:0px !important;">
											 <div style="text-align: left;margin-left: 95px;">Search FHA Number</div>
											 </td>
										</tr>
							    ...
							    <input type="text" id="fhanumber" style="width: 250px; box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.3);margin-top:-10px" onkeyup="javascript:searchFhaNumber();"/>
										...
										<tr>
											<td style="border-bottom: 0px;border-top:0px !important">Property ID</td>
											<td nowrap="" style="border-bottom: 0px;border-top:0px !important">
											 <div style="text-align: left;margin-left: 95px;">FHA Number</div>
											</td>
											</tr>
											<tr style="border-bottom:1px solid #ddd;">
											<td style="border-bottom: 0px;border-top:0px !important;">
											...
											<td style="border-bottom: 0px;border-top:0px !important;text-align:right;"><select  id="indexvalues"  style="width: 250px;margin-top:-10px" class="selectText">
													<option value="" selected>Select FHA Number</option>
												</select>	
										   
<!-- 												<input id="indexvalues" name="indexvalues" placeholder="Index Value" type="text" style="width: 260px; box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.3);"></td>											
 -->											</td>
										</tr>
										...
										<tr>
											<td nowrap="" style="border-bottom: 0px;border-top:0px !important">Default Document Type</td>
											</tr>
											<tr>
											<td style="border-bottom: 0px;border-top:0px !important"><select  name="doctype" id="doctype" class="selectText" style="width:250px;margin-top:-10px">
						  ...
						  <!-- 	<table>
							<tr>
								<td colspan=2><h4 style="padding-top: 10px;padding-bottom: 10px;" class="tableHeader">Select the type of document and folder</h4></td>
							</tr>	
							<tr valign=top>								
								<td  style="vertical-align: top;">
									<div id="divDocStatus" style="">
							...
							<tr>
								<td>
									<input id="folderNameFView" name="folderNameFView"  type="text"  size=40>
								</td>
							</tr>
							<tr valign=top>
								<td  style="vertical-align: top;">
								...
								<tr>
								<td >
								<select style="display: none" id="indextype" name="indextype" style="width: 150px" class="selectText">
									<option value=""></option>
								</select></td>
								<td >
									<input style="display: none" id="value" name="value" type="text" style="width: 150px; box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.3);"></td>
								</tr>
...
<!-- 									onclick="waitingDialog.show();"
 -->									<button id="upload_btn" class="btn btn-success " 
									...
									<button id="cancel_btn" class="btn btn-warning"
										...
										style="display:none;position: absolute;top: 25px;margin-left:58%;background-color:#FF8C00;">Cancel</button>
								</div>
							</td>
						</tr>
