			...
			if(data.key=="200"){
				  ...
				  $('#clearnotdefault').show();
				   		...
				   		$("#myTable").dataTable({
					        ...
					        buttons: [
					        	{ extend : 'excelHtml5',
					        		title:"Pending Uploads Report",
					        		text:"EXCEL REPORT",
					        		filename:"Pending Uploads Report"
...
function initial_load()
	{
	setHeader('pendingUploadReports.jsp');
	setHeaderText('Pending Uploads','Reporting & Analysis','dashboard.jsp?reports=true');
	...
	<section class="upload-document">
        <div class="container-fluid">
            ...
            <br>
                <h4 style="color: #0a68b4;">Pending Uploads Report</h4>
				<hr>
				<div>
This Report provides a list of Records currently in Pending Status.<br>
