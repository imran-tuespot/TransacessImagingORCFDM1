...
var resp = $.urlParams('file');
var restURL = $.urlParams('restURL');
...
type : "GET",
  ...
  timeout : 100000,
               success: function(msg){
                //  alert("delete file status viewer1:    "+msg)
               },
			   error:function(e){
				   console.log("error in line 32--"+e);
			   },
            });
			//this.close();
return;
...
function insertIntoSessionLog(){
	var session =sessionStorage.getItem('sessLogSessid' );
	var com = sessionStorage.getItem('sessLogCompId');
	var user = sessionStorage.getItem('sessLogUserid');
	var version = sessionStorage.getItem('sessLogver');
	var docId =sessionStorage.getItem('sessLogdocid' );	
	var restURL=sessionStorage.getItem('sessLogRestUrl' );	
	...
	request.open('POST', restURL +'/audit/saveAuditReport', true);
	request.setRequestHeader('Content-Type', 'application/json');
	request.send(JSON.stringify(documentData));   
	}
