...
<!-- action="./Getlogin" -->
  <form name="getfile" id="getfile" onKeyPress="return submitenter(this,event)">
				<div>
					 <div class="rowSetting" style="padding-bottom: 1px;border-bottom: 2px solid #F90;">
						...
						<div class="rowSetting">						
								...
								<div class="fg-line">
                                    <input id="password" name="password" class="form-control input-lg" style="background-color:#FDFDFE" placeholder="Password *" type="password" >
                                </div>							
						</div>
						...
						<td width="35%">
							<input type="button" value="Forgot Password" style="margin-right: 10px;" onClick="document.location.href='forgotPassword.jsp';" class="btn btn-primary" />
						
							<input type="button" value="Submit" id="Submit" onClick="javascript:submitform()" class="btn btn-success waves-effect waves-button waves-float" />
...
function login(){
	...
	$.ajax({
		...
		url : "http://localhost:2221/role/authenticate",
		dataType : 'json',
...
function otpcallEmail(user,tocken,emailid){
 	...
 	$.ajax({
 		type : "POST",
		url : "http://localhost:2221/role/sendTwilioEmail?userId="+user,
		headers: {  'Access-Control-Allow-Origin': '*' },
		timeout : 100000,
		 crossDomain: true,
		data:{},
...
function callafterverification(inputotp){
	...
	$.ajax({
		type : "POST",
		 crossDomain: true,
		url : "http://localhost:2221/role/verifyotp?otp="+inputotp+"&userId="+userId,
		headers: {  'Access-Control-Allow-Origin': '*' },
		timeout : 100000,
