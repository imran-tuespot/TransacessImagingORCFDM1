...
function showFiles(rootDir,data)
{
    ...
    if(fView == "advView")
    {
		$('#fileTreeDemo_4').fileTree({ root: rootDir, script: 'connectors/jqueryFileTree1.jsp', folderEvent: 'click', expandSpeed: 750, collapseSpeed: 750, expandEasing: 'easeOutBounce', collapseEasing: 'easeOutBounce', loadMessage: 'Un momento...' }, function(file) { 
		});
	}
	else if(fView = "fView")
	{
		$('#fileTreeDemo_4FView').fileTree({ root: rootDir, script: 'connectors/jqueryFileTree1.jsp', folderEvent: 'click', expandSpeed: 750, collapseSpeed: 750, expandEasing: 'easeOutBounce', collapseEasing: 'easeOutBounce', loadMessage: 'Un momento...' }, function(file) { 
							//alert(file);
		});
	}
}
