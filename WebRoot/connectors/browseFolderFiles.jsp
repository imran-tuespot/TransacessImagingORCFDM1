<!-- connector file for search page/ Browse folders -->
		...
		if(files.length > 0)
		{
			...
			String fileId = "docFile"+ i++;
			    ...
			    int dotIndex = f[0].lastIndexOf('.');
					...
					out.print("<li id=\'"+fileId+"\' class=\"file ext_" + ext + "\"><a href=\"#\" oncontextmenu=\"funct(\'"+filePath+"',event,'fileMenu',\'"+fileId+"')\"  onclick=\"javascript:getDocumentData(\'"+filePath+"')\" style=\"text-align:left\"  rel=\"" + dir + file + "\">"
					+ file + "</a></li>");
			}
				out.print("</ul>");
		}
