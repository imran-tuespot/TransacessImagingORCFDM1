	...
	List<String> dirArray = new ArrayList<String>();
		...
		if(files.length > 0)
		{
			...
			for (String file : files) {
			   ...
			   // System.out.println("file= "+file + " filePath= "+filePath + " docType= "+docType + " folderName= "+folderName);
			    int dotIndex = f[0].lastIndexOf('.');
					String ext = dotIndex > 0 ? file.substring(dotIndex + 1) : "";
					out.print("<li id=\'"+fileId+"\' class=\"file ext_" + ext + "\"><div > <a href=\"#\" onclick=\"javascript:getDocumentData(\'"+filePath+"')\" style=\"text-align: left; display: inline;overflow: hidden;text-overflow: ellipsis;float: left;width:50%\"  rel=\"" + dir + file + "\">"
					+ file + "</a><a style=\"text-align: left;overflow: hidden;text-overflow: ellipsis;\">Doc Type: "+docType+" </a></div><div><p style=\"text-align: left;width:50%;float:left;padding:0px;line-height:20px\">"+folderName+"</p><p style=\"text-align:right;width:90%;padding:0px;line-height:20px\">&nbsp;</p></div></li>");
			}
				out.print("</ul>");
		}
		/*else{
