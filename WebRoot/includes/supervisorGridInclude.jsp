...
<tr align="center">
	...
	<td style='font-size:11px;font-family: Verdana;color: green' ><b><%=successMsg %></b></td>
</tr>
<tr>
  <td  >
  ...
  <input type="text" name="lnameSearch" />  
      <input type="button" name="searchByName" value="Search" onClick="getAdvancedSearchUsers()" />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" name="registration" value="New Users" onClick="location.href='registration.jsp'" >
      </p>
  </form>  </td>
  </tr>
</table>
