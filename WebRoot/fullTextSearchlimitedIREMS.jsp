...
<div class="search-form">
   ...
   <div>
    <div class="col-sm-4">
<div class="sidemenu">
                        <h4>Full Text Search limited to IREMS#</h4>
                        <span>You can search a record by providing the IREMS# and any appropriate relevant keyword from the record in the adjoining box and clicking the Submit button.</span>
                    </div>
...
<div id="datagrid" class="col-sm-12">
 ...
 <div class="search-tables" style="text-align: center;margin-top: 10px; ">
    ...
    $(function(){
    	...
    	setHeader('fullTextSearchlimitedIREMS.jsp');
    	$("#loadingImage").hide();
    			...
    			$.ajax({
    		 		...
    		 		success : function(data) 
    		 		{
    		 			...
    		 			if(data.key==200){
    				   		  ...
    				   		  if(data.getDocumentsWithKeyword!=null&& data.commonword==null){
    				   			data=displayData(data);
    				   		  }else{
    				   			  if(data.commonword!=null){
    				   				$("#result").text(data.commonword); 
    				   			  }
    				   			data=[];
    				   		  }
    ...
    function displayData(data) {
    	...
    	$.each(data.getDocumentsWithKeyword, function(i, obj) {
    		 $('#myTableList').append('<tr><td class="dataclr"><div style="word-break: break-all;">'+obj.actualFileName+'<br>('+obj.fileSize+')<img class="cursorpointer" onclick="getPdf(\''+obj.fileName+'\',\''+obj.version+'\',\''+obj.actualFileName+'\',\''+obj.propertyName+'\')" src="images/pdfViewer.gif" alt=""></div></td><td>'+obj.documentType+'</td><td class="text-center" style="width:40px">'+obj.total+'</td><td class="dataclr text-center cursorpointer" onclick="onClickDetails(\''+obj.fileName+'\',\''+obj.documentType+'\',\''+obj.propertyName+'\')"><img class="cursorpointer" style="width: 28px;" src="assets/img/DetailsIcon1.png"/></td><td class="dataclr text-center">'+obj.createDate+'</td><td class="dataclr-1 text-center">'+obj.uploadSource+'</td> </tr> ');
        	 });
    }
